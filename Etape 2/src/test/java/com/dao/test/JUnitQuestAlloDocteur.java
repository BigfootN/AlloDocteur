...
public class JUnitQuestAlloDocteur {
    ...
    public static void initDataBase() {
        ...
        filePath += "/" + Constants.SQL_JUNIT_PATH_FILE;
        Connection conn;
    ...
    public void testFindByCriteria() {
        ...
        List<Utilisateur> utilisateursByCodePostal = serviceFacade.getUtilisateurDao()
                .findUtilisateursByCodePostal(UTILISATEUR_FIND_BY_CODE_POSTAL);
    ...
    public void testCreateUpdateDeleteUtilisateur() {
        log.debug("Entree de la methode");
        Utilisateur userCRUD = new Utilisateur("Mr", "Jean", "Ass", "jean.ass@gmail.com", "passw0rd",
