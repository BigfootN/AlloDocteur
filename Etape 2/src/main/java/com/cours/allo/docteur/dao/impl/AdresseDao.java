...
public class AdresseDao implements IAdresseDao {
    ...
    public Adresse createAdresse(Adresse adresse) {
        ...
        try {
            ...
            stmt = conn.prepareStatement(
                    "INSERT INTO adresse(idUtilisateur, rue, codePostal, ville, pays, principale) VALUES (?,?,?,?,?,?)", Statement.RETURN_GENERATED_KEYS);
    ...
    public boolean deleteAdresse(Adresse adresse) {
        ...
        try {
            conn = getConnection();
            stmt = conn.prepareStatement("DELETE FROM adresse WHERE idUtilisateur = ?");
