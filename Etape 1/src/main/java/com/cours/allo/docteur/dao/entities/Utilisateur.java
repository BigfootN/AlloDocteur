...
public class Utilisateur {
	...
	public String toString() {
		...
		ret = "idUtilisateur = " + Integer.toString(idUtilisateur) + ",";
		ret += "civilite = " + civilite + ",";
		ret += "prenom = " + prenom + ",";
		ret += "nom = " + nom + ",";
		ret += "identifiant = " + identifiant + ",";
		ret += "motPasse = " + motPasse + ",";
		ret += "dateDeNaissante = " + dateToString(dateNaissance) + ",";
		ret += "actif = " + Boolean.toString(actif) + ",";
		ret += "marquerEffacer = " + Boolean.toString(marquerEffacer) + ",";
		ret += "version = " + Integer.toString(version) + ",";
		ret += adresses.toString();
